    ...
    <div id="app">
        ...
        <main>
            <div id="content">
                <Nuxt />
                <footer>
                    &copy; Copyright <a href=https://health-procurement.io>health-procurement.io</a> - Cobbled together by Matthew Zhou.
                </footer>
            </div>
        </main>
    </div>
...
export default Vue.extend({
  components: { ProgressSteps },
    ...
    head() {
        return {
        title: 'ContractMaker: Open-source procurement clause templates for AI transparency, bias, and privacy',
        meta: [
